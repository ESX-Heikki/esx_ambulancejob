...
local BaseTimer1              = nil
local BaseTimer2              = nil
...
function StartRespawnToHospitalMenuTimer()
  if BaseTimer2 ~= nil then
	    return
	end
  BaseTimer2 = ESX.SetTimeout(Config.MenuRespawnToHospitalDelay, function()
    if IsDead then
      local elements = {}
...
function StartRespawnTimer()
  if BaseTimer1 ~= nil then
	    return
	end
  BaseTimer1 = ESX.SetTimeout(Config.RespawnDelayAfterRPDeath, function()
      if IsDead then
        RemoveItemsAfterRPDeath()
      end
      BaseTimer1 = nil
...
AddEventHandler('esx_ambulancejob:revive', function()
  ...
  Citizen.CreateThread(function()
    ...
    if BaseTimer1 ~= nil then
	    ESX.ClearTimeout(BaseTimer1)
	    BaseTimer1 = nil
	  end
	  if BaseTimer2 ~= nil then
	    ESX.ClearTimeout(BaseTimer2)
	  	BaseTimer2 = nil
	  end
